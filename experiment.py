...
if __name__ == "__main__":
    ...
    sys.stderr.write('\n========== TIMING RESULTS ==========\n')
    sys.stderr.write('Data reading time: %.2f seconds\n' % time_read)
    sys.stderr.write('Training time:     %.2f seconds\n' % time_train)
    sys.stderr.write('Evaluation time:   %.2f seconds\n' % time_eval)
    sys.stderr.write('Total time:        %.2f seconds\n' % time_total)
    sys.stderr.write('====================================\n')
